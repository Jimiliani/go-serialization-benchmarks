...
var dataLarge = loader.LoadMixedProtoData("../../loader/data/mixed.csv", 100_000)
var newDataLarge = protoSchema.MixedDataSlice{Data: make([]*protoSchema.MixedData, 100_000)}
...
var dataMedium = loader.LoadMixedProtoData("../../loader/data/mixed.csv", 100)
var newDataMedium = protoSchema.MixedDataSlice{Data: make([]*protoSchema.MixedData, 100)}
...
var dataSmall = loader.LoadMixedProtoData("../../loader/data/mixed.csv", 1)
var newDataSmall = protoSchema.MixedDataSlice{Data: make([]*protoSchema.MixedData, 1)}
